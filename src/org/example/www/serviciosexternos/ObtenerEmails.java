 ...
 */
            ...
            /**
            *  ObtenerEmails bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ObtenerEmails
    ...
    public static class Factory{
        ...
        */
        public static ObtenerEmails parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ObtenerEmails object =
                new ObtenerEmails();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"obtenerEmails".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ObtenerEmails)org.example.www.serviciosexternos.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
