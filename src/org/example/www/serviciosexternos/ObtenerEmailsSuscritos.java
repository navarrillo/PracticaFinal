 ...
 */
            ...
            /**
            *  ObtenerEmailsSuscritos bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ObtenerEmailsSuscritos
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":obtenerEmailsSuscritos",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "obtenerEmailsSuscritos",
    ...
    public static class Factory{
        ...
        */
        public static ObtenerEmailsSuscritos parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ObtenerEmailsSuscritos object =
                new ObtenerEmailsSuscritos();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"obtenerEmailsSuscritos".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ObtenerEmailsSuscritos)org.example.www.serviciosexternos.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
