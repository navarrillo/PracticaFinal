 ...
 */
    ...
    public static class Factory{
        ...
        */
        public static ObtenerEmail parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ObtenerEmail object =
                new ObtenerEmail();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"obtenerEmail".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ObtenerEmail)org.example.www.serviciosexternos.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
