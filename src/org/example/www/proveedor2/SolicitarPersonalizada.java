 ...
 */
            ...
            /**
            *  SolicitarPersonalizada bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class SolicitarPersonalizada
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":solicitarPersonalizada",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "solicitarPersonalizada",
    ...
    public static class Factory{
        ...
        */
        public static SolicitarPersonalizada parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SolicitarPersonalizada object =
                new SolicitarPersonalizada();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"solicitarPersonalizada".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SolicitarPersonalizada)org.example.www.proveedor2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
