 ...
 */
    ...
    public static class Factory{
        ...
        */
        public static LeerOfertas parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            LeerOfertas object =
                new LeerOfertas();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"LeerOfertas".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (LeerOfertas)org.example.www.gestionproveedores.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
