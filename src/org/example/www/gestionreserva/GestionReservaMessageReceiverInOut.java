 ...
 */
        ...
        */
        ...
        if((op.getName() != null) && ((methodName = org.apache.axis2.util.JavaUtils.xmlNameToJavaIdentifier(op.getName().getLocalPart())) != null)){
            ...
            if("leerReserva".equals(methodName)){
                ...
                org.example.www.gestionreserva.LeerReservaResponse leerReservaResponse23 = null;
	                        org.example.www.gestionreserva.LeerReserva wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                               ...
                                               leerReservaResponse23 =
                                                   
                                                   
                                                         skel.leerReserva(wrappedParam)
                                                    ;
                                            
                                        envelope = toEnvelope(getSOAPFactory(msgContext), leerReservaResponse23, false, new javax.xml.namespace.QName("http://www.example.org/GestionReserva/",
                                                    "leerReserva"));
                                    } else 

            if("eliminarReserva".equals(methodName)){
                
                org.example.www.gestionreserva.EliminarReservaResponse eliminarReservaResponse25 = null;
	                        org.example.www.gestionreserva.EliminarReserva wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                               ...
                                               eliminarReservaResponse25 =
                                                   
                                                   
                                                         skel.eliminarReserva(wrappedParam)
                                                    ;
                                            
                                        envelope = toEnvelope(getSOAPFactory(msgContext), eliminarReservaResponse25, false, new javax.xml.namespace.QName("http://www.example.org/GestionReserva/",
                                                    "eliminarReserva"));
                                    } else 

            if("editarReserva".equals(methodName)){
                
                org.example.www.gestionreserva.EditarReservaResponse editarReservaResponse27 = null;
	                        org.example.www.gestionreserva.EditarReserva wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                               ...
                                               editarReservaResponse27 =
                                                   
                                                   
                                                         skel.editarReserva(wrappedParam)
                                                    ;
                                            
                                        envelope = toEnvelope(getSOAPFactory(msgContext), editarReservaResponse27, false, new javax.xml.namespace.QName("http://www.example.org/GestionReserva/",
                                                    "editarReserva"));
                                    } else 

            if("leerReservaMail".equals(methodName)){
                
                org.example.www.gestionreserva.LeerReservaMailResponse leerReservaMailResponse29 = null;
	                        org.example.www.gestionreserva.LeerReservaMail wrappedParam =
                                                             (org.example.www.gestionreserva.LeerReservaMail)fromOM(
                                    msgContext.getEnvelope().getBody().getFirstElement(),
                                    org.example.www.gestionreserva.LeerReservaMail.class,
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                                
                                               leerReservaMailResponse29 =
                                                   
                                                   
                                                         skel.leerReservaMail(wrappedParam)
                                                    ;
                                            
                                        envelope = toEnvelope(getSOAPFactory(msgContext), leerReservaMailResponse29, false, new javax.xml.namespace.QName("http://www.example.org/GestionReserva/",
                                                    "leerReservaMail"));
        ...
        //
            ...
            private  org.apache.axiom.om.OMElement  toOM(org.example.www.gestionreserva.LeerReservaMail param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {

            
                        try{
                             return param.getOMElement(org.example.www.gestionreserva.LeerReservaMail.MY_QNAME,
                                          org.apache.axiom.om.OMAbstractFactory.getOMFactory());
                        } catch(org.apache.axis2.databinding.ADBException e){
                            throw org.apache.axis2.AxisFault.makeFault(e);
                        }
            ...
            private  org.apache.axiom.om.OMElement  toOM(org.example.www.gestionreserva.LeerReservaMailResponse param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {

            
                        try{
                             return param.getOMElement(org.example.www.gestionreserva.LeerReservaMailResponse.MY_QNAME,
                                          org.apache.axiom.om.OMAbstractFactory.getOMFactory());
                        } catch(org.apache.axis2.databinding.ADBException e){
                            throw org.apache.axis2.AxisFault.makeFault(e);
                        }
                    ...
                    private  org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, org.example.www.gestionreserva.LeerReservaMailResponse param, boolean optimizeContent, javax.xml.namespace.QName methodQName)
                        throws org.apache.axis2.AxisFault{
                      try{
                          org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
                           
                                    emptyEnvelope.getBody().addChild(param.getOMElement(org.example.www.gestionreserva.LeerReservaMailResponse.MY_QNAME,factory));
                        ...
                        throw org.apache.axis2.AxisFault.makeFault(e);
                         ...
                         private org.example.www.gestionreserva.LeerReservaMailResponse wrapLeerReservaMail(){
                                org.example.www.gestionreserva.LeerReservaMailResponse wrappedElement = new org.example.www.gestionreserva.LeerReservaMailResponse();
                                return wrappedElement;
                         }
        ...
        */
        ...
        try {
                ...
                if (org.example.www.gestionreserva.LeerReservaMail.class.equals(type)){
                
                        return org.example.www.gestionreserva.LeerReservaMail.Factory.parse(param.getXMLStreamReaderWithoutCaching());
                    

                }
            
                if (org.example.www.gestionreserva.LeerReservaMailResponse.class.equals(type)){
                
                        return org.example.www.gestionreserva.LeerReservaMailResponse.Factory.parse(param.getXMLStreamReaderWithoutCaching());
