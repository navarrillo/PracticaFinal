 ...
 */
            ...
            /**
            *  EliminarReservaResponse bean class
            */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":EliminarReservaResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "EliminarReservaResponse",
    ...
    public static class Factory{
        ...
        */
        public static EliminarReservaResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            EliminarReservaResponse object =
                new EliminarReservaResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"EliminarReservaResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (EliminarReservaResponse)org.example.www.gestionreserva.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
