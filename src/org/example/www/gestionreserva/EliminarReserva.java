 ...
 */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":EliminarReserva",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "EliminarReserva",
    ...
    public static class Factory{
        ...
        */
        public static EliminarReserva parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            EliminarReserva object =
                new EliminarReserva();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"EliminarReserva".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (EliminarReserva)org.example.www.gestionreserva.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
