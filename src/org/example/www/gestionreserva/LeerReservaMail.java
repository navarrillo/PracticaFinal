 ...
 */
            ...
            /**
            *  LeerReservaMail bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class LeerReservaMail
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":LeerReservaMail",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "LeerReservaMail",
    ...
    public static class Factory{
        ...
        */
        public static LeerReservaMail parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            LeerReservaMail object =
                new LeerReservaMail();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"LeerReservaMail".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (LeerReservaMail)org.example.www.gestionreserva.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
