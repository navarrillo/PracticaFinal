    ...
    public class GestionReservaSkeleton{
         ...
         */
                  ...
                  )
            {
                	...
                	/* r.localAlojamiento = true;
                	 r.localEmailCliente= "melli@melli.com";
                	 r.localFechaEntrada = new Date();
                	 r.localFechaSalida = new Date();
                	 r.localMaterial = false;
                	 r.localProfesor = true;
                	 r.localSki = true;
                	 r.localPrecio = 20;
                	 r.localNombreCliente= "melli";*/
