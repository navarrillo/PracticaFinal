...
/**
    ...
    public class GestionUsuariosSkeleton{
         ...
         */
                 ...
                 public org.example.www.gestionusuarios.LoginResponse login
                  (
                  org.example.www.gestionusuarios.Login login
                  )
            {
                	//Creacion de variable respuesta
                   ...
                   //conexion a bbdd y negocio
                     ...
                     try{
     					...
     					// Preparamos la consulta
     	                Statement s = (Statement) conexion.createStatement();
     	                String consulta = "SELECT * FROM usuarios WHERE email LIKE \""+email+"\" AND password LIKE \""+password+"\"";
