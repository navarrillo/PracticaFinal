 ...
 */
            ...
            /**
            *  SolicitarPersonalizado bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class SolicitarPersonalizado
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":solicitarPersonalizado",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "solicitarPersonalizado",
    ...
    public static class Factory{
        ...
        */
        public static SolicitarPersonalizado parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SolicitarPersonalizado object =
                new SolicitarPersonalizado();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"solicitarPersonalizado".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SolicitarPersonalizado)org.example.www.proveedor3.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
